...
const theme = ref<MenuPassThroughOptions>({
  root: `bg-input-bg dark:bg-input-bg 
        text-white dark:text-white 
        border border-white/10 dark:border-white/10
        rounded-[10px] min-w-52
  ...
  itemContent: `group transition-colors duration-200 rounded-sm text-white dark:text-white
        p-focus:bg-sidebar-hover dark:p-focus:bg-sidebar-hover p-focus:text-white dark:p-focus:text-white
        hover:bg-sidebar-hover dark:hover:bg-sidebar-hover hover:text-white dark:hover:text-white`,
